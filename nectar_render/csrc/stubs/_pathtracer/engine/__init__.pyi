...
class RenderEngine:
    ...
    def __init__(self, camera: camera.Camera, samples: typing.SupportsInt | typing.SupportsIndex = 10, ray_depth: typing.SupportsInt | typing.SupportsIndex = 8, seed: typing.SupportsInt | typing.SupportsIndex = 54321) -> None:
        ...
    def layers(self) -> data.RenderLayers:
        ...
    def render(self, arg0: Scene, arg1: SampleMode) -> None:
        ...
    def sample(self, arg0: Scene, arg1: SampleMode) -> None:
        ...
    @property
